...
(cl:defmethod initialize-instance :after ((obj bt-vector3) &key _x _y _z)
...
(cl:defmethod length ((self bt-vector3))
  (btVector3_length1 (ff-pointer self)))
...
(cl:defmethod initialize-instance :after ((obj bt-vector4) &key _x _y _z _w)
...
(cl:defmethod initialize-instance :after ((obj bt-quad-word) &key _x _y _z)
  (setf (slot-value obj 'ff-pointer) (new_btQuadWord _x _y _z)))

(cl:defmethod initialize-instance :after ((obj bt-quad-word) &key _x _y _z _w)
  (setf (slot-value obj 'ff-pointer) (new_btQuadWord _x _y _z _w)))
...
(cl:defmethod initialize-instance :after ((obj bt-quaternion) &key _x _y _z _w)
  (setf (slot-value obj 'ff-pointer) (new_btQuaternion _x _y _z _w)))

(cl:defmethod initialize-instance :after ((obj bt-quaternion) &key (_axis bt-vector3) _angle)
...
(cl:defmethod length ((self bt-quaternion))
  (btQuaternion_length1 (ff-pointer self)))
...
(cl:defmethod serialize-float ((self bt-quaternion) dataOut)
  (btQuaternion_serializeFloat (ff-pointer self) dataOut))

(cl:defmethod de-serialize-float ((self bt-quaternion) dataIn)
  (btQuaternion_deSerializeFloat (ff-pointer self) dataIn))

(cl:defmethod serialize-double ((self bt-quaternion) dataOut)
  (btQuaternion_serializeDouble (ff-pointer self) dataOut))

(cl:defmethod de-serialize-double ((self bt-quaternion) dataIn)
  (btQuaternion_deSerializeDouble (ff-pointer self) dataIn))
...
(cl:defmethod solve33 ((self bt-matrix3x3) (b bt-vector3))
  (btMatrix3x3_solve33 (ff-pointer self) b))
...
(cl:defmethod set-ignore-collision-check ((self bt-collision-object) (co bt-collision-object) (ignoreCollisionCheck t))
  (btCollisionObject_setIgnoreCollisionCheck (ff-pointer self) (ff-pointer co) ignoreCollisionCheck))

(cl:defmethod check-collide-with-override ((self bt-collision-object) (co bt-collision-object))
  (btCollisionObject_checkCollideWithOverride (ff-pointer self) (ff-pointer co)))
...
(cl:defmethod set-user-index ((self bt-collision-shape) (index cl:integer))
  (btCollisionShape_setUserIndex (ff-pointer self) index))

(cl:defmethod get-user-index ((self bt-collision-shape))
  (btCollisionShape_getUserIndex (ff-pointer self)))
...
(cl:defmethod project ((self bt-convex-shape) (trans bt-transform) (dir bt-vector3) minProj maxProj (witnesPtMin bt-vector3) (witnesPtMax bt-vector3))
  (btConvexShape_project (ff-pointer self) trans dir minProj maxProj witnesPtMin witnesPtMax))
...
(cl:defmethod compute-gyroscopic-impulse-implicit-world ((self bt-rigid-body) (dt cl:number))
  (btRigidBody_computeGyroscopicImpulseImplicit_World (ff-pointer self) dt))

(cl:defmethod compute-gyroscopic-impulse-implicit-body ((self bt-rigid-body) (step cl:number))
  (btRigidBody_computeGyroscopicImpulseImplicit_Body (ff-pointer self) step))

(cl:defmethod compute-gyroscopic-force-explicit ((self bt-rigid-body) (maxGyroscopicForce cl:number))
  (btRigidBody_computeGyroscopicForceExplicit (ff-pointer self) maxGyroscopicForce))

(cl:defmethod get-local-inertia ((self bt-rigid-body))
  (btRigidBody_getLocalInertia (ff-pointer self)))
...
(cl:defmethod has-limit ((self bt-hinge-constraint))
  (btHingeConstraint_hasLimit (ff-pointer self)))
...
(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (rbB bt-rigid-body) (pivotInA bt-vector3) (pivotInB bt-vector3) (axisInA bt-vector3) (axisInB bt-vector3) (useReferenceFrameA t))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA rbB pivotInA pivotInB axisInA axisInB useReferenceFrameA)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (rbB bt-rigid-body) (pivotInA bt-vector3) (pivotInB bt-vector3) (axisInA bt-vector3) (axisInB bt-vector3))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA rbB pivotInA pivotInB axisInA axisInB)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (pivotInA bt-vector3) (axisInA bt-vector3) (useReferenceFrameA t))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA pivotInA axisInA useReferenceFrameA)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (pivotInA bt-vector3) (axisInA bt-vector3))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA pivotInA axisInA)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (rbB bt-rigid-body) (rbAFrame bt-transform) (rbBFrame bt-transform) (useReferenceFrameA t))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA rbB rbAFrame rbBFrame useReferenceFrameA)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (rbB bt-rigid-body) (rbAFrame bt-transform) (rbBFrame bt-transform))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA rbB rbAFrame rbBFrame)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (rbAFrame bt-transform) (useReferenceFrameA t))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA rbAFrame useReferenceFrameA)))

(cl:defmethod initialize-instance :after ((obj bt-hinge-accumulated-angle-constraint) &key (rbA bt-rigid-body) (rbAFrame bt-transform))
  (setf (slot-value obj 'ff-pointer) (new_btHingeAccumulatedAngleConstraint rbA rbAFrame)))

(cl:defmethod get-accumulated-hinge-angle ((self bt-hinge-accumulated-angle-constraint))
  (btHingeAccumulatedAngleConstraint_getAccumulatedHingeAngle (ff-pointer self)))

(cl:defmethod set-accumulated-hinge-angle ((self bt-hinge-accumulated-angle-constraint) (accAngle cl:number))
  (btHingeAccumulatedAngleConstraint_setAccumulatedHingeAngle (ff-pointer self) accAngle))

(cl:defmethod get-info1 ((self bt-hinge-accumulated-angle-constraint) info)
  (btHingeAccumulatedAngleConstraint_getInfo1 (ff-pointer self) info))
...
(cl:defclass bt-hinge2-constraint()
  ((ff-pointer :reader ff-pointer)))

...
(cl:defconstant BT_BULLET_VERSION 284)

(cffi:defcfun ("_wrap_btGetVersion" btGetVersion) :int)

(cl:defconstant BT_LARGE_FLOAT 1d18)

(cffi:defcstruct btInfMaskConverter)

(cffi:defcvar ("btInfinityMask" btInfinityMask)
 btInfMaskConverter)

(cffi:defcfun ("_wrap_btGetInfinityMask" btGetInfinityMask) :int)
...
(cl:defconstant BT_ONE 1.0d0)

(cl:defconstant BT_ZERO 0.0d0)

(cl:defconstant BT_TWO 2.0d0)

(cl:defconstant BT_HALF 0.5d0)
...
(cffi:defcfun ("_wrap_btAngle__SWIG_0" btAngle) :float
  (v1 :pointer)
  (v2 :pointer))
...
(cffi:defcfun ("_wrap_btQuaternion_serialize" btQuaternion_serialize) :void
  (self :pointer)
  (dataOut :pointer))

(cffi:defcfun ("_wrap_btQuaternion_deSerialize" btQuaternion_deSerialize) :void
  (self :pointer)
  (dataIn :pointer))

(cffi:defcfun ("_wrap_btQuaternion_serializeFloat" btQuaternion_serializeFloat) :void
  (self :pointer)
  (dataOut :pointer))

(cffi:defcfun ("_wrap_btQuaternion_deSerializeFloat" btQuaternion_deSerializeFloat) :void
  (self :pointer)
  (dataIn :pointer))

(cffi:defcfun ("_wrap_btQuaternion_serializeDouble" btQuaternion_serializeDouble) :void
  (self :pointer)
  (dataOut :pointer))

(cffi:defcfun ("_wrap_btQuaternion_deSerializeDouble" btQuaternion_deSerializeDouble) :void
  (self :pointer)
  (dataIn :pointer))
...
(cffi:defcfun ("_wrap_length" _length) :float
  (q :pointer))

(cffi:defcfun ("_wrap_btAngle__SWIG_1" btAngle) :float
  (q1 :pointer)
  (q2 :pointer))
...
(cffi:defcstruct btQuaternionFloatData
	(m_floats :pointer))

(cffi:defcstruct btQuaternionDoubleData
	(m_floats :pointer))
...
(cffi:defcfun ("_wrap_btMatrix3x3_solve33" btMatrix3x3_solve33) :pointer
  (self :pointer)
  (b :pointer))
...
(cffi:defcfun ("_wrap_btCollisionObject_setIgnoreCollisionCheck" btCollisionObject_setIgnoreCollisionCheck) :void
  (self :pointer)
  (co :pointer)
  (ignoreCollisionCheck :pointer))

(cffi:defcfun ("_wrap_btCollisionObject_checkCollideWithOverride" btCollisionObject_checkCollideWithOverride) :pointer
  (self :pointer)
  (co :pointer))
...
(cffi:defcfun ("_wrap_btCollisionShape_setUserIndex" btCollisionShape_setUserIndex) :void
  (self :pointer)
  (index :int))

(cffi:defcfun ("_wrap_btCollisionShape_getUserIndex" btCollisionShape_getUserIndex) :int
  (self :pointer))
...
(cffi:defcfun ("_wrap_btRigidBody_computeGyroscopicImpulseImplicit_World" btRigidBody_computeGyroscopicImpulseImplicit_World) :pointer
  (self :pointer)
  (dt :float))

(cffi:defcfun ("_wrap_btRigidBody_computeGyroscopicImpulseImplicit_Body" btRigidBody_computeGyroscopicImpulseImplicit_Body) :pointer
  (self :pointer)
  (step :float))

(cffi:defcfun ("_wrap_btRigidBody_computeGyroscopicForceExplicit" btRigidBody_computeGyroscopicForceExplicit) :pointer
  (self :pointer)
  (maxGyroscopicForce :float))

(cffi:defcfun ("_wrap_btRigidBody_getLocalInertia" btRigidBody_getLocalInertia) :pointer
  (self :pointer))
...
(cffi:defcfun ("_wrap_btHingeConstraint_hasLimit" btHingeConstraint_hasLimit) :pointer
  (self :pointer))
...
(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_0" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (rbB :pointer)
  (pivotInA :pointer)
  (pivotInB :pointer)
...
(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_1" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (rbB :pointer)
  (pivotInA :pointer)
  (pivotInB :pointer)
...
(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_2" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (pivotInA :pointer)
  (axisInA :pointer)
  (useReferenceFrameA :pointer))

(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_3" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (pivotInA :pointer)
  (axisInA :pointer))

(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_4" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (rbB :pointer)
  (rbAFrame :pointer)
  (rbBFrame :pointer)
...
(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_5" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (rbB :pointer)
  (rbAFrame :pointer)
  (rbBFrame :pointer))

(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_6" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (rbAFrame :pointer)
  (useReferenceFrameA :pointer))

(cffi:defcfun ("_wrap_new_btHingeAccumulatedAngleConstraint__SWIG_7" new_btHingeAccumulatedAngleConstraint) :pointer
  (rbA :pointer)
  (rbAFrame :pointer))

(cffi:defcfun ("_wrap_btHingeAccumulatedAngleConstraint_getAccumulatedHingeAngle" btHingeAccumulatedAngleConstraint_getAccumulatedHingeAngle) :float
  (self :pointer))

(cffi:defcfun ("_wrap_btHingeAccumulatedAngleConstraint_setAccumulatedHingeAngle" btHingeAccumulatedAngleConstraint_setAccumulatedHingeAngle) :void
  (self :pointer)
  (accAngle :float))

(cffi:defcfun ("_wrap_btHingeAccumulatedAngleConstraint_getInfo1" btHingeAccumulatedAngleConstraint_getInfo1) :void
  (self :pointer)
  (info :pointer))

(cffi:defcfun ("_wrap_delete_btHingeAccumulatedAngleConstraint" delete_btHingeAccumulatedAngleConstraint) :void
  (self :pointer))
...
(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getActiveConstraintRowSolverGeneric" btSequentialImpulseConstraintSolver_getActiveConstraintRowSolverGeneric) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_setConstraintRowSolverGeneric" btSequentialImpulseConstraintSolver_setConstraintRowSolverGeneric) :void
  (self :pointer)
  (rowSolver :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getActiveConstraintRowSolverLowerLimit" btSequentialImpulseConstraintSolver_getActiveConstraintRowSolverLowerLimit) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_setConstraintRowSolverLowerLimit" btSequentialImpulseConstraintSolver_setConstraintRowSolverLowerLimit) :void
  (self :pointer)
  (rowSolver :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getScalarConstraintRowSolverGeneric" btSequentialImpulseConstraintSolver_getScalarConstraintRowSolverGeneric) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getSSE2ConstraintRowSolverGeneric" btSequentialImpulseConstraintSolver_getSSE2ConstraintRowSolverGeneric) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getSSE4_1ConstraintRowSolverGeneric" btSequentialImpulseConstraintSolver_getSSE4_1ConstraintRowSolverGeneric) :pointer
  (self :pointer))
...
(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getSSE2ConstraintRowSolverLowerLimit" btSequentialImpulseConstraintSolver_getSSE2ConstraintRowSolverLowerLimit) :pointer
  (self :pointer))

(cffi:defcfun ("_wrap_btSequentialImpulseConstraintSolver_getSSE4_1ConstraintRowSolverLowerLimit" btSequentialImpulseConstraintSolver_getSSE4_1ConstraintRowSolverLowerLimit) :pointer
  (self :pointer))

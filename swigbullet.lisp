...
(cffi:defcfun ("_wrap_btVector3_length1" btVector3_length1) :float
  (self :pointer))
...
(cffi:defcfun ("_wrap_btQuaternion_length1" btQuaternion_length1) :float
  (self :pointer))
...
(cffi:defcfun ("_wrap_length" length1) :float
  (q :pointer))
